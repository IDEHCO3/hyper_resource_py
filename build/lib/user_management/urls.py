...
urlpatterns = format_suffix_patterns((
    ...
    url(r'^hyper-user-register/?$', views.HyperUserRegister.as_view(), name='HyperUserRegister'),
    url(r'^hyper-user-login/?$', views.HyperUserLogin.as_view(), name='HyperUserLogin'),
